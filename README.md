...
PoseGuard 是一个本地运行的多人姿态跟踪与疑似风险行为辅助预警程序，可自主运行于弱网环境，于端侧进行视觉处理与风险预警，无需部署本地或云端服务器进行处理，减轻改造与升级调试成本。重点关注低文化水平，农村与偏远地区环境的金融反诈视觉模型，通过高精度视觉算法分析人体姿态，环境情况，对资金账户交易时所遇到的诈骗风险行为进行即时检测与管控。可识别多种风险行为：多人进入监控区、疑似持手机贴耳通话、长时间停留。红色框只表示需要人工关注，不代表身份、违法事实或诈骗结论。
